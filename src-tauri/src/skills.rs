...
fn get_builtin_skills() -> Vec<RemoteSkill> {
    vec![
        ...
        RemoteSkill {
            ...
            description: "获取实时天气信息和天气预报，支持全球城市查询，无需 API 密钥".to_string(),
            version: "1.0.0".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 15000,
            category: "生活服务".to_string(),
            tags: vec!["天气".to_string(), "生活".to_string(), "实用".to_string()],
            installed: false,
        ...
        RemoteSkill {
            ...
            tags: vec!["VPN".to_string(), "网络".to_string(), "远程".to_string()],
            installed: false,
            update_available: false,
        },
        ...
        RemoteSkill {
            ...
            tags: vec!["笔记".to_string(), "Obsidian".to_string(), "Markdown".to_string()],
            installed: false,
            update_available: false,
        },
        ...
        RemoteSkill {
            ...
            tags: vec!["视频".to_string(), "ffmpeg".to_string(), "媒体".to_string()],
            installed: false,
            update_available: false,
        },
        RemoteSkill {
            name: "TTS 语音".to_string(),
            slug: "tts".to_string(),
            description: "文字转语音，支持多种声音和语言".to_string(),
            version: "1.0.0".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 4500,
            category: "媒体处理".to_string(),
            tags: vec!["语音".to_string(), "TTS".to_string()],
            installed: false,
            update_available: false,
        },
        ...
        // 系统工具类
        RemoteSkill {
            name: "腾讯云轻量服务器".to_string(),
            slug: "tencentcloud-lighthouse".to_string(),
            description: "管理腾讯云轻量应用服务器，支持实例查询、监控告警、远程命令".to_string(),
            version: "1.0.0".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 3500,
            category: "云服务".to_string(),
            tags: vec!["腾讯云".to_string(), "服务器".to_string(), "云".to_string()],
            installed: false,
            update_available: false,
        },
        RemoteSkill {
            name: "腾讯云 COS".to_string(),
            slug: "tencent-cloud-cos".to_string(),
            description: "腾讯云对象存储管理，支持文件上传下载、图片处理、智能封面".to_string(),
            version: "1.0.0".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 2800,
            category: "云服务".to_string(),
            tags: vec!["腾讯云".to_string(), "COS".to_string(), "存储".to_string()],
            installed: false,
            update_available: false,
        },
        RemoteSkill {
            name: "系统健康检查".to_string(),
            slug: "healthcheck".to_string(),
            description: "检查系统安全配置、SSH 加固、防火墙设置，支持自动化修复".to_string(),
            version: "1.0.0".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 4000,
            category: "系统工具".to_string(),
            tags: vec!["安全".to_string(), "运维".to_string(), "系统".to_string()],
            installed: false,
            update_available: false,
        },
        ...
        RemoteSkill {
            ...
            description: "浏览器自动化，支持页面导航、点击、截图，适合爬虫和测试".to_string(),
            version: "1.0.0".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 5500,
            category: "自动化".to_string(),
            tags: vec!["浏览器".to_string(), "爬虫".to_string(), "自动化".to_string()],
            installed: false,
            update_available: false,
        },
        RemoteSkill {
            name: "Web 搜索".to_string(),
            slug: "web-search".to_string(),
            description: "使用 DuckDuckGo 搜索网页，无需 API 密钥".to_string(),
            version: "1.0.0".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 8000,
            category: "搜索".to_string(),
            tags: vec!["搜索".to_string(), "网页".to_string()],
            installed: false,
            update_available: false,
        },
        ...
        // 协作工具类
        RemoteSkill {
            name: "ClawFlow".to_string(),
            slug: "clawflow".to_string(),
            description: "工作流自动化引擎，支持任务编排、状态管理、异步执行".to_string(),
            version: "1.0.0".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 3000,
            category: "自动化".to_string(),
            tags: vec!["工作流".to_string(), "自动化".to_string()],
            installed: false,
            update_available: false,
        },
        ...
        // ========== 实际可用插件 ==========
        RemoteSkill {
            name: "微信助手 (OpenClaw)".to_string(),
            slug: "openclaw-weixin".to_string(),
            description: "微信消息发送、接收、联系人管理，支持私聊和群聊操作".to_string(),
        ...
        RemoteSkill {
            name: "钉钉助手 (DDingTalk)".to_string(),
            slug: "ddingtalk".to_string(),
            description: "钉钉消息发送、接收、群组管理，支持机器人推送和审批流程".to_string(),
            version: "1.0.0".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 22000,
        ...
        RemoteSkill {
            name: "元宝 Bot".to_string(),
            slug: "openclaw-plugin-yuanbao".to_string(),
            description: "腾讯元宝智能机器人，支持对话交互和知识问答".to_string(),
            version: "2.7.2".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 18000,
            category: "即时通讯".to_string(),
            tags: vec!["元宝".to_string(), "AI".to_string(), "机器人".to_string()],
            installed: false,
            update_available: false,
        },
        RemoteSkill {
            name: "LightClawBot".to_string(),
            slug: "lightclawbot".to_string(),
            description: "轻量级机器人框架，支持定时任务、主动消息、多平台集成".to_string(),
            version: "1.0.0".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 15000,
            category: "AI 增强".to_string(),
            tags: vec!["机器人".to_string(), "自动化".to_string(), "定时任务".to_string()],
            installed: false,
            update_available: false,
        },
        RemoteSkill {
            name: "记忆系统 (TDAI)".to_string(),
            slug: "memory-tdai".to_string(),
            description: "四层记忆系统：自动捕获对话、结构化记忆、用户画像、长期记忆召回".to_string(),
            version: "1.0.0".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 12000,
            category: "AI 增强".to_string(),
            tags: vec!["记忆".to_string(), "AI".to_string(), "知识管理".to_string()],
            installed: false,
            update_available: false,
        },
        RemoteSkill {
            name: "ADP OpenClaw".to_string(),
            slug: "adp-openclaw".to_string(),
            description: "OpenClaw 适配器插件，扩展多平台兼容性".to_string(),
            version: "1.0.0".to_string(),
            author: "OpenClaw".to_string(),
            downloads: 8000,
            category: "AI 增强".to_string(),
            tags: vec!["适配器".to_string(), "兼容".to_string()],
            installed: false,
            update_available: false,
        },
    ]
